...
//            , DVCdmLine name, DVCdmText description, Size aSize, DVCdmPVMass aMass) {
//        super(aWaresType, aSize, name, description, aMass, new DVCdmPVEnergy(1000)
...
//    public DAbmWaresContainerClass(Size aSize, DVCdmLine name, DVCdmText description) {
//        super(aSize, name, description
...
//    }
//
//    public DAbmWaresContainerClass(String idStr, Size aSize, DVCdmLine name, DVCdmText description) {
//        super(idStr, aSize, name, description
//                , new DVCdmPVMass(aSize.getMaxVolume().getBaseValue() * 100, DVCdmUnit.KnownUnit.kg)   // 100kg / m³
//                , new DVCdmPVEnergy(aSize.getMaxVolume().getBaseValue() * 100, DVCdmUnit.KnownUnit.J) // 100J / m³
//                , new DVCdmDoubleFloat(1)
//                , new DVCsmGoodFlowList()
